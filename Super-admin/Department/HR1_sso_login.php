<?php
/**
 * ROBUST SSO RECEIVER for HR1 - Version 3.0
 */
...
echo '<html><head><title>HR1 Authentication</title><link rel="icon" type="image/png" href="https://hr1.atierahotelandrestaurant.com/assets/image/logo2.png"></head><body style="font-family:sans-serif; text-align:center; padding-top:50px;">';
