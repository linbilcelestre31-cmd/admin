                                    ...
                                    <div class="facility-content">
                                        ...
                                        <div style="display: flex; gap: 8px;">
                                            <button class="btn btn-primary" style="flex: 1;"
                                                ...
                                                <span class="icon-img-placeholder">➕</span> Reserve
                                            </button>
                                            <button class="btn btn-danger" style="padding: 0.75rem;"
                                                onclick="deleteFacility(<?= $facility['id'] ?>)" title="Delete Facility">
                                            ...
                                            <td>
                                                <div style="display: flex; gap: 8px; justify-content: center;">
                                                    ...
                                                    <button class="btn btn-danger btn-sm btn-icon"
                                                        onclick="deleteFacility(<?= $f['id'] ?>)" title="Delete Facility">
                                                        <i class="fa-solid fa-trash"></i>
                                                    </button>
                                                </div>
                                            </td>
                        ...
                        <div class="card management-card management-reports" style="display: block;">
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-wrapper">
                                    <h4 style="margin-bottom: 1rem;"><span class="icon-img-placeholder">🏢</span> Master
